...
BOT_TOKEN = "8694226141:AAGRoPjvDZuLYRZAXeuLf7MnQQtbLnD2VaQ"
...
REVIEWS_CHANNEL_URL = "https://t.me/sindromovrep"
...
async def menu_reviews(message: Message) -> None:
    await db.upsert_user(message)
    url = REVIEWS_CHANNEL_URL if valid_tme_url(REVIEWS_CHANNEL_URL) else "https://t.me/sindromovrep"
    keyboard = InlineKeyboardMarkup(
...
@vksindromov.message(F.text == "👨‍💻 Поддержка")
